  ...
  return (
    <div className="Conditions_Layout">
      <div className="Conditions">
        ...
        <Input id="Match_Duration" type="number" value="15" Text="Match duration:" onChange={InputChange}/>
        <Input id="Match_Freezing" type="number" value="2" Text="Freezing time minutes:" onChange={InputChange}/>
        <Input id="Match_Halftime" type="number" value="2" Text="Halftime minutes:" onChange={InputChange}/>
